<div class="wrap" id="pixabay" data-search="">
    <h1>
        ...
        <div class="media-frame-content">
            <div class="media-toolbar wp-filter">
                <div class="media-toolbar-secondary">
                    ...
                    <label class="screen-reader-text" for="pixabay-categories">
                        Filter by type
                    </label>
                    <select class="attachment-filters" id="pixabay-categories">
                    ...
                    <label class="screen-reader-text" for="pixabay-order-by">
                        Order By
                    </label>
                    <select class="attachment-filters" id="pixabay-order-by">
